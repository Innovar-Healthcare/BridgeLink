...
public class MirthLauncher {
    ...
    private static final String[] LOG4J_JAR_FILES = { "./server-lib/log4j/log4j-core-2.25.4.jar",
            "./server-lib/log4j/log4j-api-2.25.4.jar",
            "./server-lib/log4j/log4j-1.2-api-2.25.4.jar" };
