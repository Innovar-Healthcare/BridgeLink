...
public class ExtensionManagerPanel extends javax.swing.JPanel {
    ...
    public void showExtensionProperties() {
        ...
        if (metaData != null) {
            ...
            new com.mirth.connect.client.ui.extensionmanager.ExtensionInfoDialog(name, type, "Installed", author, version, url, description);
        }
    }
    ...
    private void initComponents() {
        ...
        restartRequiredLabel.setText("The BridgeLink Server and Administrator must be restarted before your changes will take effect.");
