...
public class MessageExportPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        exportServerRadio.setToolTipText("<html>Store exported files on the BridgeLink Server, in the Root Path specified below.</html>");
        exportLocalRadio.setToolTipText("<html>Store exported files on this computer, in the Root Path specified below.</html>");
        rootPathTextField.setToolTipText("<html>The root path to store the exported files/folders or compressed file.<br/>Relative paths will be resolved against the BridgeLink Server home directory.</html>");
