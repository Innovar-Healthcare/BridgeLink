...
public class MessageBrowserAdvancedFilter extends MirthDialog {
    ...
    private void initComponents() {
        ...
        serverIdField.setToolTipText("<html>The GUID of the message in the BridgeLink database.<br>This can be retrieved from the Meta Data tab in the Message Browser.</html>");
