...
public class WebServiceListener extends ConnectorSettingsPanel {
    ...
    private void initComponents() {
        ...
        classNameField.setToolTipText("<html>The fully qualified class name of the web service that should be hosted.<br>If this is a custom class, it should be added in a custom jar so it is loaded with BridgeLink.</html>");
    }
