    ...
    private void refreshUI() {
        ...
        if (!stats.isStatsSupported()) {
            ...
            unsupportedPanel.add(new JLabel(
                    "<html><span style='font-size:14pt;'><b>Hit/Miss distribution is not available for this eviction policy.</b></span></html>"
            ));
            ...
            emptyStatsPanel.add(new JLabel(
                    "<html><span style='font-size:14pt;'><b>Hit/Miss distribution will appear after lookups occur.</b></span></html>"
            ));
