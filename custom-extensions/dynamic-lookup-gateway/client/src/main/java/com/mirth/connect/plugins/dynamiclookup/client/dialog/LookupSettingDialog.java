...
public class LookupSettingDialog extends MirthDialog {
    ...
    private void save() {
        ...
        try {
            parent.mirthClient.setPluginProperties("Lookup Table Management System", toSave.toAuditPruneProperties(), true);
    ...
    /**
     * Applies the given LookupProperties values to the dialog UI controls. Called after loading settings from the server.
     */
