 ...
 * from an earlier version of BridgeLink to a later version. A custom converter is registered
 * with XStream that automatically detects objects that implement this interface and runs the
 * appropriate interface methods.
 * </p>
 * 
 * <p>
 * When adding this interface to a class in a given version of BridgeLink, the migrate methods
