...
public class RecoveryTests {
    ...
    private void createDestinationMessage(DonkeyDao dao, ConnectorMessage sourceMessage, int metaDataId, Status status) {
        ...
        if (status == Status.PENDING || status == Status.SENT) {
            destinationMessage.setMessageContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.TRANSFORMED, sourceMessage.getEncoded().getContent(), null, false));
            destinationMessage.setMessageContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.ENCODED, sourceMessage.getEncoded().getContent(), null, false));
            destinationMessage.setMessageContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.SENT, sourceMessage.getEncoded().getContent(), null, false));
            destinationMessage.setMessageContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.RESPONSE, responseContent, null, false));
            ...
            if (status == Status.SENT) {
                destinationMessage.setMessageContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.PROCESSED_RESPONSE, responseContent, null, false));
