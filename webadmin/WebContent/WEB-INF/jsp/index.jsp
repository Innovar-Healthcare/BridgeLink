...
<html>
    <head>
        ...
        <title>BridgeLink Administrator</title>
        ...
        <div id="centerWrapper" class="container">
            <div class="row">
                ...
                <div id="mcadministrator" class="col-xs-6 col-xs-6-custom">
                    <h1 style="text-align: center;">BridgeLink Administrator</h1>
                    ...
                    <div id="launchbuttoncontainer">
                        ...
                        <a class="btn btn-md btn-themebutton" href="javascript:launchAdministrator()">Launch BridgeLink Administrator</a>
    				 	...
    				 	<c:when test="${actionBean.secureHttps == true}">
		              	...
		              	<c:otherwise>
		              		<div id="securesiteaccess">
		              			<p id="httpsInfoParagraph">The BridgeLink Web Dashboard must be accessed over HTTPS. Click below button to switch to the secure site.</p>
		                   		<div class="help-block">
