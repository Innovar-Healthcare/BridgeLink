 ...
 * declares no fields; it exists so the responseGenerationProperties element appears (empty) in the
 * serialized defaults.
 */
...
public class MockDIMSEResponseGenerationProperties extends ResponseGenerationProperties {
